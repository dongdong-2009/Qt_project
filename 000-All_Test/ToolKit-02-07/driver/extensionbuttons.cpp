...
void ExtensionButtons::initStatus()
{
    ...
    for(int i = 0; i < EXTEND_BUTTON_NUMBER; ++i )
    {
        ...
        m_IsLightOn[i] = 0;
        m_RecordEmit[i] = 0;
//        m_emitSigCancleFlag[i] = 2;
//        m_emitSigPressFlag[i] = 2;
    }
}
...
{
    if (index < 0 || index > 36)  // 0 <= index < 24
    {
...
//                        setLightOff(btNumber);
                        ...
                        printf("extensionbtn_%d be cancled\n", btNumber + 13);
