...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RGBGame_t, stringdata) + ofs \
...
void *RGBGame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RGBGame.stringdata))
...
int RGBGame::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< QColor*>(_v) = timeColor(); break;
        default: break;
        }
        _id -= 2;
